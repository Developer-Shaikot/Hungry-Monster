...
const renderMealInfo = meal => {
    ...
    <ul class="list-unstyled mb-0">
        <li><i class="icon-check icons"></i>${meal.strMeasure1}, ${meal.strIngredient1}</li>
        <li><i class="icon-check icons"></i>${meal.strMeasure2}, ${meal.strIngredient2}</li>
        <li><i class="icon-check icons"></i>${meal.strMeasure3}, ${meal.strIngredient3}</li>
        <li><i class="icon-check icons"></i>${meal.strMeasure4}, ${meal.strIngredient4}</li>
    </ul>
`;
};
